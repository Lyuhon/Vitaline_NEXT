...
// //                                         maxQuantity={product.stockQuantity || 0} // Передаём правильное свойство
// //                                         initialQty={1}
// //                                         stock={inStock} // Передаём boolean
// //                                     />
...
// // Функция для генерации метаданных
// export async function generateMetadata({ params }: { params: { slug: string } }) {
//     const { slug } = params; // Удалён await
//     const product: Product = await fetchSingleProduct(slug);
...
//                 <span className="current_bread_cumb">{product.name}</span>
//                 <span className="bread_divider">&gt;</span>
//             </div>
...
//                         <div className={`stock_status ${inStock ? '' : 'out_of_stock'}`}>
//                             <span className={inStock ? '' : 'out_of_stock'}>
