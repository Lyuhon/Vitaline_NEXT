...
//                     <Link href="#">правилами покупки</Link> и{' '}
...
//         apartment: string;
//     };
//     updateDeliveryAddress: (info: Partial<typeof deliveryAddress>) => void;
...
//                                 onChange={(e) =>
//                                     updateDeliveryAddress({ street: e.target.value })
//                                 }
//                                 required
//                             />
//                         </div>
...
//                                 onChange={(e) =>
//                                     updateDeliveryAddress({ apartment: e.target.value })
//                                 }
//                             />
//                         </div>
//                     </>
...
//             {/* Кнопка «Отправить» в форме может дублировать действие «Оформить заказ» */}
//             {/* Если не нужна (так как у вас есть своя кнопка в сводке), можно скрыть */}
...
/** ========== CheckoutForm (CheckoutForm.tsx) ========== */
// Обратите внимание: используем forwardRef, чтобы «прокинуть» ref из родителя на <form />
