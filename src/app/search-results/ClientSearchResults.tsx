...
//     const searchParams = useSearchParams(); // Добавляем useSearchParams для динамического получения параметров
//     const [results, setResults] = useState<AlgoliaHit[]>([]);
//     const [isLoading, setIsLoading] = useState(true);
//     const [searchInput, setSearchInput] = useState('');

//     // Используем searchParams из useSearchParams, а если его нет, берём initialSearchParams
