...
export default async function LocaleLayout({
  ...
  // КРИТИЧЕСКИ ВАЖНО: Получаем переводы для текущей локали
  ...
  return (
    <html lang={locale}>
      <head>
        ...
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Vitaline Trade - Оптовый магазин витаминов в Ташкенте" />
      </head>
      <body>
        {/* ВОТ ГЛАВНОЕ - ПРОВАЙДЕР! */}
