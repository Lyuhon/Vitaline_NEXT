...
export default async function AllBrandsPage({ params }: { params?: { locale?: string } }) {
    const locale = params?.locale || await getLocale();
    ...
    return (
        <section className='home_brand_list'>
            <div className="home_categories_section_heading">
                <div className="general_heading_block">
                    <Link className="section_read_more---- px-[7px] py-[3px] rounded-[5px] bg-[#f67800] text-[#fff] text-[14px]" href={`/${locale}/shop`}>
                        {t('allProducts')}
                    </Link>
                    <Link className="section_read_more---- px-[7px] py-[3px] rounded-[5px] bg-[#f67800] text-[#fff] text-[14px]" href={`/${locale}/brand_list`}>
                        {t('allBrands')}
                    </Link>
                </div>
                <div className='mb-[20px]'></div>
